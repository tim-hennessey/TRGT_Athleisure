...
app.Animation = (function () {
	...
	// --------------------------------------------------------------------------------------
	function start() {
        tl1.from(jersey, 1, {x:-300, ease: Cubic.easeOut})
            .from(pants, 1, {x:-300, ease: Cubic.easeOut},"-=.75")
            .from(shoes, 1, {x:-300, ease: Cubic.easeOut},"-=.8")
            .from(hoodie, 1, {x:-300, ease: Cubic.easeOut},"-=.8")
            .from(txt1, 1, {y: -177, ease: Cubic.easeInOut})
	}
